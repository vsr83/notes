...
(see Figure \ref{fig:classicrel}). This is called the \textbf{headlight effect}.
...
In many software implementations, the aberration correction is applied in terms of 
spherical coordinates. We expand uncorrected direction 
\begin {eqnarray}
    \vu p
    = 
    \begin {bmatrix}
...
\newpage
\section{Human Perception and Computer Graphics}
