...
\begin {figure}
  ...
  \end {center}
\end {figure} 
Consider now light in the context of Special Relativity. Then, simple 
application of Lorentz transformation yields 
\begin {eqnarray}
    \begin {bmatrix}
        t' \\ x' \\ y' \\ z'
    \end {bmatrix}
...
\newpage
\restoregeometry
\section{Spectrum, Color and Radiation}
...
\newpage
\section{Ray Tracing and Special Relativity}
