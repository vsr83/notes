...
\subsection{Human Vision and LMS Color Space}
...
\subsection{CIE 1931 Color Spaces and sRGB Encoding \label{sec:srgb}}
...
\subsection{Example: Visible Wavelength Range}
